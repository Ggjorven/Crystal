...
MarioEntity::MarioEntity(const std::string_view& debugName, const glm::vec2& position, const glm::vec2& size, std::filesystem::path texturePath)
...
void MarioEntity::OnUpdate(Timestep& ts)
{
}

void MarioEntity::OnRender()
{
